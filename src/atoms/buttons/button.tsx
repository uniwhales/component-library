...
const ButtonPrimary = styled(Button) <Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  ${(props) => !props.disabled && css`
    ...
    opacity: 0.9;
    background: ${props.theme.colors.MAIN_BLUE};
    z-index: ${props.theme.zIndex.BACKDROP};
    &:hover {
      background: ${props.theme.colors.SKY};
    }
    &:active {
...
const ButtonSecondary = styled(Button) <Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  height: ${({ height }) => height};
  svg {
    fill: ${(props) => props.theme.colors.SHADE_MINUS_3}!important;
  }
  // disabled state
  ${(props) => props.disabled && css`
    transition: background 0.45s ease;
...
const ButtonTertiary = styled(Button) <Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  svg {
    ...
    fill: ${(props) => props.theme.colors.SHADE_MINUS_2}!important;
  }
  // disabled state
  ${(props) => props.disabled && css`
      background: ${props.theme.colors.SHADE_PLUS_3};
  ...
  // active state
  ${(props) => !props.disabled && css`
    color: ${props.theme.colors.SHADE_MINUS_2};
    background-color: transparent;
    border: 2px solid transparent;
    &:hover {
       color: ${props.theme.colors.SHADE_MINUS_3};
       background: ${props.theme.colors.SHADE_MINUS_1};
      svg {
    ...
    &:active {
     color: ${props.theme.colors.SHADE_MINUS_3};
     background: ${props.theme.colors.SHADE_PLUS_1};
     border: 2px solid ${props.theme.colors.YELLOW};
      svg {
        fill: ${props.theme.colors.SHADE_MINUS_3}!important;
      }
...
const ButtonPrimaryAction = styled(ButtonTertiary) <Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  padding: 10px;
    // active state
  ${(props) => !props.disabled && css`
    color: ${props.theme.colors.SHADE_MINUS_1};
  `};
  // disabled state
  ${(props) => props.disabled && css`
      background: none;
...
const ButtonSecondaryAction = styled(Button)<Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  ${(props) => !props.disabled && css`
    ...
    &:active {
      svg {
        fill: ${props.theme.colors.MAIN_BLUE}!important;
      }
    };
  `}
`;
...
const ButtonSecondaryActionInverse = styled(Button) <Pick<ButtonProps, 'width' | 'height'> & { isMobile?: boolean }>`
  ...
  svg {
    fill: ${(props) => props.theme.colors.SHADE_MINUS_1}!important;
  }
  border: none;
  // disabled state
  ${(props) => props.disabled && css`
...
const ButtonSpecialSmallSubtle = styled(Button)<{ color?: string }>`
  background: none;
  border: none;
  color: ${({ theme, color }) => color || theme.colors.SHADE_MINUS_2};
  svg {
    width: 16px;
    height: 16px;
    fill: ${({ theme, color }) => color || theme.colors.SHADE_MINUS_2}!important;
  };
  // disabled
  ${(props) => props.disabled && css`
    border: ${({ theme }) => `2px solid ${theme.colors.BG_SHADE_PLUS_4}`};
    ...
    svg {
      fill: ${({ theme }) => theme.colors.SHADE_PLUS_1}!important;
    };
  `}
  // active state
  ${({ disabled }) => !disabled && css`
    &:hover {
      color: ${({ theme }) => theme.colors.SHADE_MINUS_3}!important;
      svg {
        fill: ${({ theme }) => theme.colors.SHADE_MINUS_3}!important;
      };
    }
    &:active {
      color: ${({ theme }) => theme.colors.MAIN_BLUE}!important;
      svg {
        fill: ${({ theme }) => theme.colors.MAIN_BLUE}!important;
      };
    }
  `};
`;
const ButtonIconOnly = styled(Button)`
  ...
  ${(props) => !props.disabled && css`
    background: none;
   &:hover {
      background: ${props.theme.colors.MANGO};
      svg {
        fill: ${props.theme.colors.DARK_BLUE}!important;
      }
    };
    &:active {
      background:none;
...
const SquareButton = styled.button<Pick<ButtonProps, 'size'> & { isMobile?: boolean }>`
  ...
  border-radius: 10px;
  border: ${({ theme }) => `2px solid ${theme.colors.MAIN_BLUE}`};
  ...
  svg {
    cursor: ${({ disabled }) => (disabled ? 'not-allowed' : 'pointer')}!important;
    fill: ${({ theme }) => theme.colors.SHADE_MINUS_2}!important;
  }
    // disabled state
  ${({ disabled, theme }) => disabled && css`
      background: ${theme.colors.SHADE_PLUS_3};
      color: ${theme.colors.SHADE_PLUS_1};
      border: 2px solid transparent;

      svg {
        fill: ${theme.colors.SHADE_PLUS_1}!important;
      }
  `}
  // active state
  ${({ theme, disabled }) => !disabled && css`
...
const OnboardingPrimaryButton = styled(Button) <Pick<ButtonProps, 'width'>>`
  ...
  ${(props) => props.disabled && css`
      background: ${props.theme.colors.MAIN_BLUE};
      color: ${props.theme.colors.SKY};
      border:2px solid transparent;
      svg {
        fill: ${props.theme.colors.SKY}!important;
      }
  `}
  // active state
  ${(props) => !props.disabled && css`
    ...
    border: 2px solid transparent;
    opacity: 0.9;
    background: ${props.theme.colors.DARK_BLUE};
    z-index: ${props.theme.zIndex.BACKDROP};
    &:hover {
      background: ${props.theme.colors.SKY};
    }
...
const OnboardingSecondaryButton = styled(Button) <Pick<ButtonProps, 'width'>>`
  ...
  // disabled state
  ${(props) => props.disabled && css`
      background: ${props.theme.colors.MEDIUM_BLUE};
      color: ${props.theme.colors.DARK_BLUE};
      border:2px solid transparent;
