...
export const DeleteColor = () => (
  ...
  >
    <path
      fill="#0993EC"
      d="M19.643 9.489c0 .067-.533 6.808-.837 9.645-.19 1.741-1.313 2.797-2.997 2.827-1.293.03-2.56.04-3.805.04-1.323 0-2.616-.01-3.872-.04-1.627-.039-2.75-1.116-2.931-2.827-.313-2.847-.837-9.578-.846-9.645a.794.794 0 01.19-.558.71.71 0 01.524-.234h13.87c.2 0 .38.088.523.234.134.158.2.353.181.558"
    />
    <path
      fill="#F8F9FF"
